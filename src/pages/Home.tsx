        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-stone-900">NeuroMães</span>
            </div>
            <div className="hidden md:flex items-center gap-6">
              <a href="#sobre" className="text-stone-600 hover:text-purple-600 font-medium transition-colors">Sobre</a>
              <a href="#recursos" className="text-stone-600 hover:text-purple-600 font-medium transition-colors">Recursos</a>
              <a href="#comunidade" className="text-stone-600 hover:text-purple-600 font-medium transition-colors">Comunidade</a>
            </div>
            <div>
              <Link to="/login" className="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-full shadow-sm text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 transition-colors">
      ...
      <section className="relative bg-purple-50 py-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-5xl font-extrabold text-stone-900 tracking-tight mb-6">
              Acolhimento, informação e cuidado para <span className="text-purple-600">mães atípicas</span>.
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#sobre" className="inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-full shadow-sm text-base font-medium text-white bg-purple-600 hover:bg-purple-700 transition-colors">
                Explorar Conteúdo
              </a>
              <Link to="/login" className="inline-flex items-center justify-center px-6 py-3 border-2 border-purple-200 rounded-full text-base font-medium text-purple-700 bg-white hover:bg-purple-50 transition-colors">
      ...
      <section id="sobre" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-stone-900 mb-4">Entendendo a Neurodivergência</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-stone-50 p-8 rounded-2xl border border-stone-100 hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-6">
                <Brain className="w-6 h-6 text-blue-600" />
              </div>
              <h3 className="text-xl font-bold text-stone-900 mb-3">Autismo (TEA)</h3>
            ...
            <div className="bg-stone-50 p-8 rounded-2xl border border-stone-100 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-stone-900 mb-3">TDAH</h3>
              <p className="text-stone-600 leading-relaxed">
            ...
            <div className="bg-stone-50 p-8 rounded-2xl border border-stone-100 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-stone-900 mb-3">Dislexia e outros</h3>
              <p className="text-stone-600 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="lg:w-1/2">
              ...
              <Link to="/login" className="inline-flex items-center justify-center px-8 py-4 border border-transparent rounded-full shadow-lg text-lg font-medium text-stone-900 bg-white hover:bg-stone-100 transition-colors">
                Acessar o Aplicativo <ArrowRight className="w-5 h-5 ml-2" />
              </Link>
            </div>
            <div className="lg:w-1/2 relative">
              <div className="aspect-square rounded-3xl overflow-hidden bg-stone-800 relative">
                <img 
                  ...
                  <div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-2xl">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-stone-300 text-sm">Plataforma Integrada</p>
                      </div>
                    </div>
                    <p className="text-stone-200 text-sm">Conectando famílias a especialistas com amor e praticidade.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-stone-50 py-12 border-t border-stone-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold text-stone-900">NeuroMães</span>
          </div>
